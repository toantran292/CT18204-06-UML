...
\begin{longtblr}[caption = {Mô tả thuộc tính của lớp DienBienTranDau},
...
\end{longtblr}
  ...
  \begin{longtblr}[caption = {Mô tả phương thức của lớp DienBienTranDau},
  ...
  \SetCell[r=2]{} layDienBien() & \SetCell[r=2]{} public & \SetCell[c=4]{} Không có tham số &                      &                   &            & \SetCell[r=2]{} String    & \SetCell[r=2]{} Lấy diễn biến hiện tại của đội trong một trận đấu loại. \\
</table>
                               &                        &                  &                &            &        &                             &                                                                                         \\
  \end{longtblr}
  \end{document}