...
\begin{longtblr}[caption = {Mô tả thuộc tính của lớp TranDauTrucTiep},
...
\end{longtblr}
  ...
  \begin{longtblr}[caption = {Mô tả phương thức của lớp TranDauTrucTiep},
  ...
  \SetCell[r=2]{} layKetQua() & \SetCell[r=2]{} public & \SetCell[c=4]{} Có 0 tham số &                      &                   &            & \SetCell[r=2]{}OrderedList   & \SetCell[r=2]{} Trả về danh sách có thứ tự về kết quả thi đấu của các đội tham gia. \\
</table>
                              &                         &               &          &            &            &                             &                                                                                         \\
\end{longtblr}
  \end{document}