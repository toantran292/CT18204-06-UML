...
\begin{longtblr}[caption = {Mô tả thuộc tính của lớp TaiTro},
  ...
  id&public&String&null&8&&&ID một hợp đồng được tài trợ cho một giải đấu cụ thể. \\
\end{longtblr}
  ...
  \SetCell[r=2]{} layDSTaiTro() & \SetCell[r=2]{} public & \SetCell[c=4]{} Không có tham số &                      &                   &            & \SetCell[r=2]{} List     & \SetCell[r=2]{} Lấy danh sách hợp đồng tài trợ của một nhà tài trợ cho giải đấu đang xét. \\
</table>
                               &                        &                  &                &            &        &                             &                                                                                         \\
  \end{longtblr}
  \end{document}