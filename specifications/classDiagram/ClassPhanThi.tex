...
\begin{longtblr}[caption = {Mô tả thuộc tính của lớp PhanThi},
...
\end{longtblr}
  ...
  \begin{longtblr}[caption = {Mô tả phương thức của lớp PhanThi},
  ...
  \SetCell[r=2]{} layTongSLTranDau() & \SetCell[r=2]{} public & \SetCell[c=4]{} Không có tham số &                      &                   &            & \SetCell[r=2]{} Int     & \SetCell[r=2]{} Lấy tổng số lượng trận đấu diễn ra trong phần thi đấu đang xét. \\
</table>
                               &                        &                  &                &            &        &                             &                                                                                         \\
  \end{longtblr}
  \end{document}