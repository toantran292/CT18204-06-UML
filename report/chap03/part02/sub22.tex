\phantomsection
\subsubsection{Lớp DiemSo}
\setcounter{figure}{0}
\setcounter{paragraph}{0}

\phantomsection
\paragraph{Mô tả thuộc tính của lớp DiemSo}\mbox{}

Các thuộc tính của lớp DiemSo được mô tả như ở \myreftb{tab:class22-1-spec}

\begin{adjustwidth}{-2cm}{-1cm}
  \begin{longtblr}[caption = {Mô tả thuộc tính của lớp DiemSo},
    label = {tab:class22-1-spec},]{
...
\phantomsection
\paragraph{Mô tả phương thức của lớp DiemSo}\mbox{}

Các phương thức của lớp DiemSo được mô tả như ở \myreftb{tab:class22-2-spec}

\begin{adjustwidth}{-2cm}{-1cm}
  \begin{longtblr}[caption = {Mô tả phương thức của lớp DiemSo},
    label = {tab:class22-2-spec},]{
    width=1\linewidth, rowhead=1, hlines,vlines,
