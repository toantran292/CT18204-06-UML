\phantomsection
\subsubsection{Lớp DoiHinhMau}
\setcounter{figure}{0}
\setcounter{paragraph}{0}

\phantomsection
\paragraph{Mô tả thuộc tính của lớp DoiHinhMau}\mbox{}

Các thuộc tính của lớp DoiHinhMau được mô tả như ở \myreftb{tab:class1-1-spec}

\begin{adjustwidth}{-2cm}{-1cm}
  \begin{longtblr}[caption = {Mô tả thuộc tính của lớp DoiHinhMau},
...
\phantomsection
\paragraph{Mô tả phương thức của lớp DoiHinhMau}\mbox{}

Các phương thức của lớp DoiHinhMau được mô tả như ở \myreftb{tab:class1-2-spec}
