...
Các thuộc tính của lớp SuKien được mô tả như ở \myreftb{tab:class25-1-spec}
...
% \phantomsection
% \paragraph{Mô tả phương thức của lớp SuKien}\mbox{}

% Các phương thức của lớp SuKien được mô tả như ở \myreftb{tab:class25-2-spec}

% \begin{adjustwidth}{-2cm}{-1cm}
%   \begin{longtblr}[caption = {Mô tả phương thức của lớp SuKien},
%     label = {tab:class25-2-spec},]{
%     width=1\linewidth, rowhead=1, hlines,vlines,
